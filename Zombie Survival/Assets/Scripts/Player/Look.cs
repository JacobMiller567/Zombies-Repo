...
public class Look : MonoBehaviour // More complex then then other scripts
{
    ...
    // TEST //
        ...
        {
            Cursor.lockState = CursorLockMode.None; // Used to make it so the cursor wont move around on the screen or outside of the application
            Cursor.visible = !activeCursor; // Used to make it so the cursor is not visible
        }
